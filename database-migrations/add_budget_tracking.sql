-- Migration: Add budget tracking fields to budget_config table
-- This adds available_budget and total_profit_loss columns for better budget management

-- Add available_budget column (tracks current available budget after trades)
ALTER TABLE budget_config 
ADD COLUMN IF NOT EXISTS available_budget DECIMAL(15,2) DEFAULT NULL;

-- Add total_profit_loss column (cumulative P&L from closed trades)
ALTER TABLE budget_config 
